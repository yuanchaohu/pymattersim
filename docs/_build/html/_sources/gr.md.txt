...
$$
g(r) = \frac{1}{N \rho} \left< \sum_{i \neq j} \delta (r - |\vec r_{ij}|) \right>
$$
...
$$
g_{\alpha \beta}(r) = \frac{V}{N_{\alpha} N_{\beta}} \left< \sum_{i \neq j; i \in \alpha; j \in \beta} \delta (r - |\vec r_{ij}|) \right>
$$
...
$$
g_A(r) = \frac{1}{N \rho} \left< \sum_{i \neq j} \delta (r - |\vec r_{ij}|)A_i A_j \right> = \left< A(r) A(0) \right>
$$
