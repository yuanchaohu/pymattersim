...
class NematicOrder():
    def __init__(
        ...
        Inputs:
            1. snapshots_orientation (reader.reader_utils.Snapshots): snapshot object of input trajectory
                                (returned by reader.dump_reader.DumpReader)
                                !!! DumpFileType=LAMMPSVECTOR
            2. snapshots_position (reader.reader_utils.Snapshots): snapshot object of input trajectory
                                (returned by reader.dump_reader.DumpReader)
                                !!! DumpFileType=LAMMPS or LAMMPSCENTER or any other to provide atom positions
                                Not mandatory if only calculate nematic tensor
