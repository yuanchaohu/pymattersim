...
class TestSq(unittest.TestCase):
    ...
    def test_Sq_unary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.036721, 0.098449, 0.0966  , 0.087589, 0.102995, 0.167968,
                                        ...
                                        0.745138, 0.564783, 0.903626, 1.217604, 0.964599, 0.982553,
                                        0.960175, 0.923612, 0.993903, 1.321256, 0.981675, 1.113917,
                                        1.082202, 0.990689, 0.960879, 1.252601, 1.195605, 1.155925,
                                        1.142982],
                                        result["Sq"].values)
    ...
    def test_Sq_binary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.038646, 0.008722, 0.01594 , 0.032078, 0.02863 , 0.024956,
                                        ...
                                        0.486289, 1.023237, 1.093542, 0.755509, 0.711677],
                                        result["Sq"][::5].values)
        np.testing.assert_almost_equal([0.010016, 0.006038, 0.007666, 0.004854, 0.009   , 0.009333,
                                        ...
                                        0.416637, 0.800454, 1.666437, 1.33979 , 0.625133],
                                        result["Sq11"][::5].values)
        np.testing.assert_almost_equal([0.180699, 0.021479, 0.038509, 0.112131, 0.095764, 0.079835,
                                        0.110043, 0.251578, 0.361017, 0.663501, 0.796434, 1.013789,
                                        1.478495, 2.565442, 1.193986, 0.925219, 1.078914, 1.294598,
                                        0.240288, 0.621367, 0.288448, 0.793002, 0.841751, 0.822287,
                                        1.417872, 2.38481 , 2.387517, 1.079952, 0.616024, 0.792896,
    ...
    def test_Sq_ternary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.093943, 0.043634, 0.06753 , 0.131979, 1.701307, 1.393587,
                                        ...
                                        1.082076, 1.033043, 1.069499, 0.99042 , 1.018081, 1.000083,
                                        1.023933, 0.728486, 1.055094, 0.838312, 0.923572, 0.978838,
                                        0.890376],
                                        result["Sq"][::5].values)
        np.testing.assert_almost_equal([0.076259, 0.076837, 0.106201, 0.13778 , 1.911361, 0.91595 ,
                                        ...
                                        1.144762, 1.025841, 1.05647 , 1.021978, 1.046636, 0.93741 ,
                                        1.036012, 0.952977, 1.022905, 0.872951, 0.954655, 1.038649,
                                        0.982382],
                                        result["Sq11"][::5].values)
        np.testing.assert_almost_equal([1.045742, 0.72311 , 1.017411, 0.54045 , 0.919682, 1.360917,
                                        ...
                                        1.071631, 1.148394, 0.994904, 1.079142, 0.98099 , 1.277323,
                                        0.905934, 1.588855, 0.836732, 1.016146, 1.112143, 1.07673 ,
                                        0.842176],
                                        result["Sq22"][::5].values)
        np.testing.assert_almost_equal([0.316158, 0.506681, 0.715554, 0.842354, 0.933485, 0.95514 ,
                                        0.860464, 0.820994, 1.019856, 1.018377, 0.974524, 0.904845,
                                        0.900496, 0.930537, 1.171108, 0.895679, 1.051473, 0.963053,
                                        0.926793, 1.014876, 0.983708, 0.934353, 0.797349, 0.864113,
                                        0.897462],
    ...
    def test_sq_condition(self) -> None:
        ...
        sq22_selected = conditional_sq(snapshot, qvector=np.array([[1,1,0], [1,0,1], [0,1,1]]), condition=snapshot.particle_type==2)[1]["Sq"].values
