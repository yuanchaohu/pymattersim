...
class TestSq(unittest.TestCase):
    ...
    def test_Sq_unary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.036721,
                                        0.098449,
                                        0.0966,
                                        0.087589,
                                        0.102995,
    ...
    def test_Sq_binary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.038646,
                                        0.008722,
                                        0.01594,
                                        0.032078,
                                        0.02863,
                                        ...
                                        0.711677],
                                       result["Sq"][::5].values)
        np.testing.assert_almost_equal([0.010016,
                                        0.006038,
                                        0.007666,
                                        0.004854,
                                        0.009,
        ...
        np.testing.assert_almost_equal([0.180699,
                                        0.021479,
                                        0.038509,
                                        0.112131,
                                        0.095764,
    ...
    def test_Sq_ternary(self) -> None:
        ...
        np.testing.assert_almost_equal([0.093943,
                                        0.043634,
                                        0.06753,
                                        0.131979,
                                        1.701307,
                                        ...
                                        0.890376],
                                       result["Sq"][::5].values)
        np.testing.assert_almost_equal([0.076259,
                                        0.076837,
                                        0.106201,
                                        0.13778,
                                        1.911361,
                                        ...
                                        0.982382],
                                       result["Sq11"][::5].values)
        np.testing.assert_almost_equal([1.045742,
                                        0.72311,
                                        1.017411,
                                        0.54045,
                                        0.919682,
                                        ...
                                        0.842176],
                                       result["Sq22"][::5].values)
        np.testing.assert_almost_equal([0.316158,
                                        0.506681,
                                        0.715554,
                                        0.842354,
                                        0.933485,
    ...
    def test_sq_condition(self) -> None:
        ...
        """
        logger.info(
            f"Starting test conditional_sq using {self.test_file_ternary}...")
        readdump = DumpReader(self.test_file_ternary, ndim=3)
        readdump.read_onefile()
        snapshot = readdump.snapshots.snapshots[0]

        sq22_selected = conditional_sq(snapshot, qvector=np.array([[1, 1, 0], [1, 0, 1], [
                                       0, 1, 1]]), condition=snapshot.particle_type == 2)[1]["Sq"].values
        sq22_results = sq(readdump.snapshots, qvector=np.array(
            [[1, 1, 0], [1, 0, 1], [0, 1, 1]])).getresults()["Sq22"].values

        np.testing.assert_almost_equal(
            sq22_selected.round(4), sq22_results.round(4))
        logger.info(
            f"Finishing test conditional_sq using {self.test_file_ternary}...")
