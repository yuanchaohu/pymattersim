...
class TestVector(unittest.TestCase):
    ...
    def test_divergence_curl_2d(self) -> None:
        ...
        v1 = self.input_v.snapshots.snapshots[0].positions
        divergence1 = divergence_curl(self.input_vp.snapshots.snapshots[0],v1,ppp,neighborfile)
        np.testing.assert_almost_equal(
            divergence1[:10],
            np.array([
    ...
    def test_divergence_curl_3d(self) -> None:
        ...
        divergence,curl = divergence_curl(self.input_vp.snapshots.snapshots[0],v1,ppp,neighborfile)
