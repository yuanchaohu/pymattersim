...
class Test_Coarse_Graining(unittest.TestCase):
    ...
    def test_spatial_average(self) -> None:
        ...
        np.testing.assert_almost_equal(np.array([0.57277224, 0.53034253, 0.63984439, 0.49477918, 0.75474255,
    ...
    def test_gaussian_blurring_2d(self) -> None:
        ...
        np.testing.assert_almost_equal(np.array([0.58704447, 0.56470494, 0.56153822, 0.57766662, 0.60697736,
    ...
    def test_gaussian_blurring_3d(self) -> None:
        ...
        np.testing.assert_almost_equal(np.array(([2.89425578, 2.85272144, 2.81284045, 2.77540638, 2.7436408 ,
    ...
    def test_gaussian_blurring_2d_vector(self) -> None:
        ...
        input_v = DumpReader(self.test_file_2d_v, ndim=2,filetype=DumpFileType.LAMMPSVECTOR,columnsids=[5,6])
        ...
        np.testing.assert_almost_equal(np.array([[ 0.0770776 ,  0.07731522],
