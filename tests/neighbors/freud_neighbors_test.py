...
class TestFreudNeighbors(unittest.TestCase):
    ...
    def test_FreudNeighbors_2d(self) -> None:
        ...
        self.assertEqual([3946, 4039, 5385, 8949, 9131],
                         item[2:])
        ...
        # benchmaking with old code
        self.assertEqual([0.967596, 0.849745, 1.078595, 0.82854, 0.077368],
                         item[2:])
    ...
    def test_FreudNeighbors_3d(self) -> None:
        ...
        self.assertEqual([281, 435, 1056, 1238, 1535, 1973, 2350,
                          3126, 3327, 3801, 5135, 5263, 6135, 6238],
                         item[2:])
        os.remove('dump.neighbor.dat')
