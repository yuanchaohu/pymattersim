...
"""
    Reading snapshots generated by various simulators for materials science, chemistry, and physics,
    such as LAMMPS and Hoomd-blue engines.

    By specifying the filetype argument when initializing DumpReader class, so far the module can read:
    ...
    3. For the xs and x types in orthogonal cells with periodic boundary conditions, 
        ...
        In non-periodic boundary conditions, there should be no particles at the outside of the cell.
...
class DumpReader:
    """
    Read computer simulation trajectories/snapshots for atomic or molecular systems
    The example simulator includes but not limit to: 
        1. LAMMPS
        2. Hoomd-Blue
    """
